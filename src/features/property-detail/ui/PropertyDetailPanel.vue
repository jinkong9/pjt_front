...
<template>
  <aside
    ...
    class="property-detail-panel price-panel-frame absolute bottom-0 left-0 top-20 z-40 flex w-full flex-col overflow-hidden bg-white shadow-2xl md:border md:border-neutral-200"
  >
